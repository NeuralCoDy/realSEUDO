...
UTESTCASE zipcodes(Utest *utest)
{
	...
	// The classic way: no total gradient, stochastic descent
	options.isClassifier_ = false;
	options.maxMultiplier_ = 100;
	options.weightSaturation_ = 1.;
	options.totalGradient_ = false;
	options.momentum_ = false;
	options.autoRate2_ = false;
	...
	double rate = 50.; // higher than 0.05;
