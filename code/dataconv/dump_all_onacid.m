...
function dump_all_onacid(from, to)
	...
	trace_prefix = res_dir + "onacid_trace_";
	outl_prefix = res_dir + "onacid_outlines_";
	show_prefix = res_dir + "onacid_show_";
	...
	for i=from:to
		...
		load(f + ".mat");
		run(normf + "_onacid_shapes");
		run(normf + "_onacid_traces");
